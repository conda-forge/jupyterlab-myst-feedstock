...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-myst-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15112&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-myst-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-myst` can be installed with:

```
conda install jupyterlab-myst
```

It is possible to list all of the versions of `jupyterlab-myst` available on your platform with:
